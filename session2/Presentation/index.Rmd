...
TODO: show function to add stars corresponding to custom p-values
...
Last slide before going into ggplot2 and dplyr
Would like to show flow from original data to tidy/transformed data to plotting
